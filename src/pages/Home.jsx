...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen font-sans antialiased text-gray-800 overflow-x-hidden">
      {/* HERO */}
      <header className="relative min-h-screen bg-gradient-to-br from-[#0A0F2C] via-[#121B45] to-[#1E2A78] text-white overflow-hidden">

  {/* 🔵 HD Overlay Texture */}
  <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-soft-light"></div>

  {/* 🔵 HD Blur Light Effects */}
  <div className="absolute -top-40 -left-20 w-[500px] h-[500px] bg-blue-500/30 blur-[150px] rounded-full"></div>
  <div className="absolute top-20 right-0 w-[450px] h-[450px] bg-violet-500/30 blur-[170px] rounded-full"></div>
  <div className="absolute bottom-0 left-10 w-[350px] h-[350px] bg-indigo-400/20 blur-[140px] rounded-full"></div>
    ...
    <div className="max-w-7xl mx-auto px-6 py-28 lg:py-40">
      <div className="grid lg:grid-cols-2 gap-14 items-center">
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show">
          <h1 className="text-5xl lg:text-7xl font-extrabold leading-tight tracking-tight drop-shadow-xl">
          ...
          <motion.p variants={itemUp} className="mt-8 text-xl max-w-2xl leading-relaxed text-white/90">
          ...
          <motion.div variants={itemUp} className="mt-10 flex flex-wrap gap-6">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-10 py-5 bg-yellow-400 text-gray-900 rounded-full font-bold flex items-center gap-3 hover:bg-yellow-300 transition shadow-[0_0_40px_rgba(255,200,0,0.4)]">
            ...
            <motion.a
              ...
              className="px-10 py-5 border-2 border-white/40 rounded-full backdrop-blur-xl bg-white/10 hover:bg-white/20 transition">
              Explore Services
            </motion.a>
          </motion.div>
          ...
          <motion.div variants={itemUp} className="mt-10 flex gap-6 flex-wrap">
            {["99.9% Uptime", "300+ Projects", "150+ Clients", "10+ Years"].map((text) => (
              <span key={text} className="inline-block bg-white/10 text-white px-5 py-2 rounded-full text-sm font-medium backdrop-blur-xl border border-white/20 shadow">
                {text}
              </span>
            ))}
          </motion.div>
        ...
        <motion.div variants={float3D} animate="animate" style={{ perspective: 2000 }} className="relative">
          <motion.div
            ...
            className="relative bg-white/10 backdrop-blur-2xl rounded-3xl p-6 border border-white/20 shadow-[0_0_50px_rgba(255,255,255,0.2)]"
            style={{ transformStyle: "preserve-3d" }}
          >
            {/* 🔥 HD HERO IMAGE LIKE SYNTES */}
            <img
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-transparent rounded-2xl mix-blend-overlay pointer-events-none"></div>
...
>
  ...
  <div className="absolute inset-0">
    <div className="absolute top-20 left-20 w-120 h-120 bg-purple-400/20 rounded-full blur-3xl animate-pulse" />
    <div className="absolute bottom-32 right-20 w-96 h-96 bg-indigo-400/20 rounded-full blur-3xl animate-pulse delay-1000" />
  </div>
  ...
  <div className="max-w-7xl mx-auto px-6 relative z-10">
    ...
    >
      ...
      >
        <span className="text-sm font-semibold tracking-widest uppercase text-purple-700 bg-white/20 px-6 py-2 rounded-full backdrop-blur">
          Our Services
        </span>
      </motion.div>
      <h2 className="mt-6 text-6xl md:text-7xl font-extrabold bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-500 bg-clip-text text-transparent leading-tight">
        Built for the Future
      </h2>
      <p className="mt-6 text-xl md:text-2xl text-gray-700 max-w-5xl mx-auto font-light">
      ...
      {services.map((service, index) => (
        ...
        >
          ...
          <div className="relative h-full bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl overflow-hidden
                          ...
                          before:absolute before:inset-0 before:bg-gradient-to-br before:from-purple-500/5 before:via-indigo-500/5 before:to-pink-500/5 before:opacity-0 before:transition-opacity before:duration-500 group-hover:before:opacity-100">
            {/* Gradient Glow */}
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-purple-500/30 via-indigo-500/30 to-pink-500/30 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-700 -z-10" />
            {/* Floating Orb */}
            ...
            <div className="relative mb-6">
              <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-purple-500 to-indigo-500 flex items-center justify-center shadow-2xl 
                              group-hover:scale-110 transition-transform duration-500 animate-pulse group-hover:animate-none">
                <service.icon className="w-11 h-11 text-white" />
              </div>
              <div className="absolute -inset-4 bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-full blur-2xl -z-10 
            ...
            <motion.div
              ...
              className="mt-6 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full"
            />
          </div>
        </motion.div>
      ))}
    ...
    >
      <motion.a
        ...
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        className="inline-flex items-center gap-4 px-12 py-6 bg-gradient-to-r from-purple-600 to-indigo-500 text-white text-xl font-bold rounded-full shadow-2xl hover:shadow-purple-500/50 transition-all duration-300"
      >
      ...
      {/* ABOUT WITH COUNTERS */}
<section className="py-24 bg-gradient-to-b from-[#0A1F4F] via-[#081A3E] to-[#04235C] text-white">
  <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
    ...
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <h2 className="text-5xl font-bold text-white">About Cloudbit</h2>
      <p className="mt-6 text-lg text-gray-300 leading-relaxed">
        We partner with ambitious companies to build modern digital products with engineering excellence.
      </p>
      <div className="mt-12 grid grid-cols-2 gap-8">
        <div ref={ref300} className="p-8 bg-white/10 rounded-2xl shadow-lg text-center backdrop-blur">
          <div className="text-5xl font-bold text-indigo-400">{count300}+</div>
          <div className="text-gray-300 mt-2">Projects Delivered</div>
        </div>
        <div ref={ref150} className="p-8 bg-white/10 rounded-2xl shadow-lg text-center backdrop-blur">
          <div className="text-5xl font-bold text-indigo-400">{count150}+</div>
          <div className="text-gray-300 mt-2">Happy Clients</div>
        </div>
        <div ref={ref10} className="p-8 bg-white/10 rounded-2xl shadow-lg text-center backdrop-blur">
          <div className="text-5xl font-bold text-indigo-400">{count10}+</div>
          <div className="text-gray-300 mt-2">Years Experience</div>
        </div>
        <div className="p-8 bg-white/10 rounded-2xl shadow-lg text-center backdrop-blur">
          <div className="text-5xl font-bold text-indigo-400">24/7</div>
    ...
    <motion.div
      ...
      className="space-y-8"
    >
      <div className="p-8 bg-white/10 rounded-3xl shadow-xl border border-white/20 backdrop-blur">
        <h3 className="text-2xl font-bold text-white">Engineering Excellence</h3>
        <p className="mt-4 text-gray-300">Trunk-based dev • Feature flags • Full test coverage</p>
      </div>
      <div className="p-8 bg-white/10 rounded-3xl shadow-xl border border-white/20 backdrop-blur">
        <h3 className="text-2xl font-bold text-white">Security First</h3>
        <p className="mt-4 text-gray-300">PCI • HIPAA • SOC2 • Regular pen tests</p>
      </div>
    </motion.div>
  </div>
</section>
...
<section className="py-28 bg-gray-50 relative overflow-hidden">
  {/* Background Blobs */}
  <div className="absolute top-0 left-0 w-96 h-96 bg-indigo-200/40 blur-3xl rounded-full -z-10" />
  <div className="absolute bottom-0 right-0 w-96 h-96 bg-purple-200/40 blur-3xl rounded-full -z-10" />
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    >
      <span className="text-sm font-semibold tracking-widest uppercase text-indigo-600 bg-indigo-100/60 px-6 py-2 rounded-full">
        Our Work
      </span>
      <h2 className="mt-6 text-6xl font-extrabold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
        Projects We Have Completed

      </h2>
      <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
        Transforming ideas into high-quality digital products trusted by global clients.
      </p>
    </motion.div>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
      {[
        {
          img: "https://placehold.co/600x400/6366f1/ffffff?text=E-Commerce+Platform",
          title: "E-Commerce Platform",
          desc: "Built a multilayer scalable e-commerce solution for high traffic.",
        },
        {
          img: "https://placehold.co/600x400/8b5cf6/ffffff?text=AI+Chat+System",
          title: "AI-Powered Chat System",
          desc: "Smart conversational AI tool using NLP & real-time processing.",
        },
        {
          img: "https://placehold.co/600x400/ec4899/ffffff?text=Fintech+App",
          title: "FinTech Wallet App",
          desc: "Secure digital wallet app with real-time transactions.",
        },
        {
          img: "https://placehold.co/600x400/f59e0b/ffffff?text=Education+Portal",
          title: "Education LMS Portal",
          desc: "Interactive LMS with live classes, tests, analytics.",
        },
        {
          img: "https://placehold.co/600x400/14b8a6/ffffff?text=Cloud+Automation",
          title: "Cloud & DevOps Automation",
          desc: "Infrastructure as Code, CI/CD, autoscaling.",
        },
        {
          img: "https://placehold.co/600x400/0ea5e9/ffffff?text=CRM+Dashboard",
          title: "Enterprise CRM Dashboard",
          desc: "Advanced analytics + multi-role enterprise dashboard.",
        },
      ].map((project, i) => (
        <motion.div
          key={i}
          ...
          viewport={{ once: true }}
          className="group bg-white rounded-3xl shadow-xl border overflow-hidden hover:-translate-y-3 transition-all duration-500"
        >
          ...
          <div className="p-6">
            ...
            <div className="mt-4">
              <motion.button
                whileHover={{ scale: 1.05 }}
                className="px-5 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full text-sm"
              >
                View Project →
              </motion.button>
            </div>
...
<section className="py-24 bg-white" id="clients">
  <div className="max-w-7xl mx-auto px-6 text-center">
    ...
    <p className="mt-4 text-lg text-gray-600">
      Trusted by businesses, loved by people ❤️
    </p>
    ...
    <div className="grid md:grid-cols-3 gap-12 mt-16">
      ...
      >
        <img
          ...
          className="w-24 h-24 mx-auto rounded-full border-4 border-indigo-600 shadow"
        />
        <h3 className="mt-6 text-2xl font-bold">Arjun Mehta</h3>
        <p className="text-indigo-600 font-semibold">Founder, Mehta Tech</p>
        <p className="mt-4 text-gray-600">
          “CloudBit team is absolutely amazing! They delivered our project
          faster than expected with outstanding quality.”
        </p>
      </motion.div>
      ...
      >
        <img
          ...
          className="w-24 h-24 mx-auto rounded-full border-4 border-purple-600 shadow"
        />
        <h3 className="mt-6 text-2xl font-bold">Simran Kaur</h3>
        <p className="text-purple-600 font-semibold">CEO, Kaur Enterprises</p>
        <p className="mt-4 text-gray-600">
          “Professional, creative and very responsive. They helped us scale our
          business with a beautiful website!”
        </p>
      </motion.div>
      ...
      >
        <img
          ...
          className="w-24 h-24 mx-auto rounded-full border-4 border-pink-600 shadow"
        />
        <h3 className="mt-6 text-2xl font-bold">Rahul Verma</h3>
        <p className="text-pink-600 font-semibold">Marketing Manager</p>
        <p className="mt-4 text-gray-600">
          “Their support is excellent! I am extremely happy with the results.
          Highly recommended for any digital project.”
        </p>
      </motion.div>
...
<section
  id="contact"
  className="py-32 bg-gradient-to-br from-indigo-50 to-purple-50 relative overflow-hidden"
>
  <motion.div
  ...
  <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 relative z-10">
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="mt-12 space-y-8">
        ...
        <div>
          ...
          {sent && (
            <p className="mt-4 text-green-600 text-xl font-bold animate-pulse">
    ...
    <div className="space-y-8">
      ...
      {/* ⭐ Saharanpur Free Google Map Embed ⭐ */}
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3415.2637059789465!2d77.54233467569251!3d29.967458722013537!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390eb2a4d72bb42b%3A0x4b987c7cbbab87c5!2sSaharanpur%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1700000000000"
        width="100%"
        height="450"
        allowFullScreen=""
        loading="lazy"
        className="w-full rounded-2xl shadow-xl border-0"
      ></iframe>

      <div className="space-y-4 text-gray-700">
        <div className="flex items-center gap-3">
          <MapPin className="w-6 h-6" /> Saharanpur, Uttar Pradesh, India
        </div>

        <div className="flex items-center gap-3">
          <Mail className="w-6 h-6" /> hello@cloudbit.example
        </div>

        <div className="flex items-center gap-3">
          <Clock className="w-6 h-6" /> Mon–Fri, 9:30am–7:00pm IST
        </div>
      </div>
    </div>
  </div>
    ...
    <section className="py-24 bg-gradient-to-r from-blue-800 via-blue-900 to-blue-950 text-white">
  <div className="max-w-7xl mx-auto px-6">
